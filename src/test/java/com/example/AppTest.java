...
public class AppTest 
{
    ...
    public static Object[][] proveedordatos(){
        return new Object[][]{
            ...
            {"masculino", "0", "La edad del cotizante debe ser mayor o igual a 18"},
            {"femenino", "17", "La edad del cotizante debe ser mayor o igual a 18"},
            {"femenino", " ", "Debe de ingresar su edad para poder realizar la cotizacion"},
            {"femenino", "dieciocho", "Debe de ingresar valores numericos en el campo edad"},
            {"femenino", "18.5", "Debe de ingresar valores numericos entero en el campo edad"}
        };
    }
